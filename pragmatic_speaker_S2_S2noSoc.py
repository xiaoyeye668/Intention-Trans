...
def yoon_S1(values, alpha1, costs, L, phi_grid_n=40, lib='np'):
...
def yoon_likelihood(alpha1, values, omega, costs, phi, L, alpha2, phi_grid_n=100, lib='np'):

    S1 = yoon_S1(values, alpha1, costs, L, phi_grid_n, lib)
...
if __name__=='__main__':
    ...
    az.to_netcdf(
        yoon_trace, 
        'traces/2020model_S2_2wTune4w_LS2map_S2noSoc_2alpha_newV.cdf'
    )
    az.to_netcdf(ppc, 'ppcs/ppc_2020model_S2_2wTune4w_LS2map_S2noSoc_2alpha_newV.cdf')
